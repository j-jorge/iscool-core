...
iscool::video::decoder::decode( const std::string& path )
{
    ...
    detail::format_context_pointer format_context
        ( raw_format_context, &detail::close_format_context );
    ...
    {
        ic_causeless_log
            ( iscool::log::nature::error(), "iscool::video::decoder",
...
bool iscool::video::detail::log_av_error( int result_code )
{
    ...
    ic_causeless_log
        ( iscool::log::nature::error(), "iscool::video::decoder", "%s",
...
{
    ic_causeless_log
        ( iscool::log::nature::info(), "iscool::video::decoder",
          "HW device types" );
...
void iscool::video::detail::log_codec_details
( const AVCodecContext& context, const AVCodec& codec )
{
    ic_causeless_log
        ( iscool::log::nature::info(), "iscool::video::decoder",
...
void iscool::video::detail::decoder_thread::operator()()
{
    ...
    while( true )
    {
        ...
        _shared_state.update_condition.wait
            ( lock,
              [ this ]() -> bool
              {
...
void iscool::video::detail::decoder_thread::initialize()
{
    ...
    _scale_context =
        ...
        ( sws_getContext
          ( width, height, _codec_context->pix_fmt,
            width, height, target_pixel_format,
...
void iscool::video::detail::decoder_thread::reset_stream()
{
    ...
    avformat_seek_file
        ( _format_context.get(), _video_stream_index, 0, 0,
