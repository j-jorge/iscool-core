...
{
    Json::Value value;
    EXPECT_THROW( iscool::json::cast< double >( value ),
                  iscool::json::bad_cast );

    Json::Value value0( "10" );
    EXPECT_THROW( iscool::json::cast< double >( value0 ),
                  iscool::json::bad_cast );

    Json::Value value1( true );
    EXPECT_THROW( iscool::json::cast< double >( value1 ),
                  iscool::json::bad_cast );

    Json::Value value2( Json::arrayValue );
    EXPECT_THROW( iscool::json::cast< double >( value2 ),
                  iscool::json::bad_cast );

    Json::Value value3( Json::objectValue );
    EXPECT_THROW( iscool::json::cast< double >( value3 ),
                  iscool::json::bad_cast );
}
...
{
    EXPECT_DOUBLE_EQ
        ( 84.9, iscool::json::cast< double >( Json::Value(), 84.9 ) );
    EXPECT_DOUBLE_EQ
        ( 8.49, iscool::json::cast< double >( Json::Value(), 8.49 ) );
    EXPECT_DOUBLE_EQ
        ( 1, iscool::json::cast< double >( Json::Value( 1.0 ), 8.0 ) );
}
