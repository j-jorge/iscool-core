...
TEST(iscool_json_collection_cast, vector)
{
  ...
  const std::vector<s> result(
      iscool::json::collection_cast<std::vector<s>>(input, custom_cast));
...
TEST(iscool_json_collection_cast, vector_fail)
{
  ...
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(Json::objectValue,
                                                             custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(Json::realValue,
                                                             custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(Json::intValue,
                                                             custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(
                   Json::booleanValue, custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(Json::nullValue,
                                                             custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(iscool::json::collection_cast<std::vector<s>>(Json::uintValue,
                                                             custom_cast),
               iscool::json::bad_cast);
}
...
TEST(iscool_json_collection_cast, vector_default_cast)
{
  ...
  const std::vector<std::string> result(
      iscool::json::collection_cast<std::vector<std::string>>(input));
...
TEST(iscool_json_collection_cast, array_fail)
{
  ...
  EXPECT_THROW(iscool::json::collection_cast<array_t>(input, custom_cast),
               iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::objectValue, custom_cast),
      iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::realValue, custom_cast),
      iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::intValue, custom_cast),
      iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::booleanValue, custom_cast),
      iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::nullValue, custom_cast),
      iscool::json::bad_cast);
  EXPECT_THROW(
      iscool::json::collection_cast<array_t>(Json::uintValue, custom_cast),
      iscool::json::bad_cast);
}
...
TEST(iscool_json_collection_cast, array_default_cast)
{
  ...
  const std::array<std::string, 2> result(
      iscool::json::collection_cast<std::array<std::string, 2>>(input));
