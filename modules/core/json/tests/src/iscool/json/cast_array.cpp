...
#include <iscool/json/is_of_type_array.hpp>
...
TEST(iscool_json_cast, to_array_throw)
{
  ...
  Json::Value value;
  EXPECT_THROW(iscool::json::cast<array_t>(value), iscool::json::bad_cast);

  Json::Value value0("10");
  EXPECT_THROW(iscool::json::cast<array_t>(value0), iscool::json::bad_cast);

  Json::Value value1(std::uint64_t(0x123456789abcdef));
  EXPECT_THROW(iscool::json::cast<array_t>(value1), iscool::json::bad_cast);

  Json::Value value2(Json::objectValue);
  EXPECT_THROW(iscool::json::cast<array_t>(value2), iscool::json::bad_cast);

  Json::Value value3(5.4f);
  EXPECT_THROW(iscool::json::cast<array_t>(value3), iscool::json::bad_cast);

  Json::Value value4(-10);
  EXPECT_THROW(iscool::json::cast<array_t>(value4), iscool::json::bad_cast);

  Json::Value value5;
  value5[0] = Json::Value(1);
  value5[1] = Json::Value();
  EXPECT_THROW(iscool::json::cast<array_t>(value5), iscool::json::bad_cast);

  Json::Value value6;
  value6[0] = Json::Value(1);
  value6[1] = Json::Value(2);
  value6[2] = Json::Value(3);
  EXPECT_THROW(iscool::json::cast<array_t>(value6), iscool::json::bad_cast);
}
