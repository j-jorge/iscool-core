...
namespace iscool
{
    namespace jni
    {
        namespace detail
        {
            static void java_log
            ( int level, const std::string& tag, const std::string& message );
...
void iscool::jni::detail::setup_log_delegates()
{
    ...
    static_method< void > method
        ( get_static_method< void >
          ( "iscool/jni/NativeLog", "nativeReady", "(J)V" ) );
...
void iscool::jni::detail::java_log
( int level, const std::string& tag, const std::string& message )
{
