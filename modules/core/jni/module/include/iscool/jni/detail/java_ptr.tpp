...
template< typename T >
bool
iscool::jni::java_ptr< T >::operator==( std::nullptr_t ) const
{
...
void iscool::jni::java_ptr< T >::delete_java_ref()
{
    ...
    const jobjectRefType reference_type
        ( jni_env->GetObjectRefType( _value ) );
...
template< typename T >
T iscool::jni::detail::get_method_argument_impl
<
    iscool::jni::java_ptr< T >
>::get
