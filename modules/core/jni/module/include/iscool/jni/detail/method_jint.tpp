...
*/
#ifndef ISCOOL_JNI_METHOD_JINT_TPP
#define ISCOOL_JNI_METHOD_JINT_TPP

#include <iscool/jni/check_java_exception.hpp>
#include <iscool/jni/detail/get_method_argument.hpp>

template <typename... Arg>
jint iscool::jni::method<jint>::operator()(const java_ptr<jobject>& self,
                                           Arg&&... args) const
{
  assert(check_java_exception());

  const jint result(_env->CallIntMethod(
      self.get(), _method,
