...
class iscool_style_from_declaration_json_test:
    public ::testing::Test
{
public:
...
TEST_F( iscool_style_from_declaration_json_test, number_member )
{
    const Json::Value result
        ( iscool::style::json::from_declaration( _style ) );
...
TEST_F( iscool_style_from_declaration_json_test, string_member )
{
    ...
    EXPECT_TRUE
        ( iscool::json::is_of_type< std::string >( result[ "string" ] ) );
}
...
TEST_F( iscool_style_from_declaration_json_test, declaration_member )
{
    ...
    EXPECT_TRUE
        ( iscool::json::is_of_type< std::string >( inner_style[ "member" ] ) );
}
...
TEST_F( iscool_style_from_declaration_json_test, string_values )
{
    const Json::Value result
        ( iscool::style::json::from_declaration( _style ) );
    EXPECT_EQ( "string",
               iscool::json::cast< std::string >( result[ "string" ], "" ) );
}
...
TEST_F( iscool_style_from_declaration_json_test, merged_declaration )
{
    ...
    const Json::Value result
        ( iscool::style::json::from_declaration( merged ) );
