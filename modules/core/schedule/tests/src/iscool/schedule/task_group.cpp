...
class iscool_schedule_task_group_test : public ::testing::Test
{
public:
...
TEST_F(iscool_schedule_task_group_test, single_task)
{
  ...
  group.run<iscool::schedule::test::observable_task>(
      std::ref(update_interval), std::ref(report), std::ref(complete));
...
TEST_F(iscool_schedule_task_group_test, multiple_tasks)
{
  ...
  iscool::schedule::task_group group;
  group.run<iscool::schedule::test::observable_task>(
      std::ref(update_interval_1), std::ref(report_1), std::ref(complete_1));
  group.run<iscool::schedule::test::observable_task>(
      std::ref(update_interval_2), std::ref(report_2), std::ref(complete_2));
  group.run<iscool::schedule::test::observable_task>(
      std::ref(update_interval_3), std::ref(report_3), std::ref(complete_3));
