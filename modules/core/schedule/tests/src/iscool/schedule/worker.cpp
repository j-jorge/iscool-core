...
class iscool_schedule_worker_test : public ::testing::Test
{
public:
...
void iscool_schedule_worker_test::wait(std::size_t count,
...
TEST_F(iscool_schedule_worker_test, delayed_start)
{
  ...
  const iscool::schedule::worker::handle handle(
      iscool::schedule::worker::run<iscool::schedule::test::observable_task>(
...
TEST_F(iscool_schedule_worker_test, complete_after_start)
{
  ...
  const iscool::schedule::worker::handle handle(
      iscool::schedule::worker::run<iscool::schedule::test::observable_task>(
          std::ref(update_interval), std::ref(_report), std::ref(complete)));
