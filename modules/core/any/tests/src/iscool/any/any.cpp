...
iscool::any::tests::call_counter&
iscool::any::tests::call_counter::operator=(const call_counter& that)
{
  _count = that._count;
  ++_count->copy_assign;
  return *this;
...
iscool::any::tests::call_counter&
iscool::any::tests::call_counter::operator=(call_counter&& that)
{
  _count = that._count;
  ++_count->move_assign;
  return *this;
...
namespace iscool
{
  namespace any
  {
    namespace tests
    {
      ...
      {
      public:
        ic_any_declare_visitor_interface((int));
      ...
      {
      public:
        ic_any_declare_visitor_interface((std::string));
      ...
      {
      public:
        ic_any_declare_visitor_interface((int)(std::string));
...
void iscool::any::tests::any_test_int_string_visitor::operator()(const int& v)
{
  ++int_calls;
  int_value = v;
}
...
TEST(iscool_any, visit)
{
  ...
  {
    int_value.visit<iscool::any::tests::any_test_int_visitor&>(int_visitor);
...

  {
    ...
    string_value.visit<iscool::any::tests::any_test_int_visitor&>(int_visitor);
