...
{
  return iscool::memory::get_global_thread_safe_pool<formatter>().construct(
      pattern);
}
...
template int
iscool::strings::detail::append_to_formatter<const char*>(formatter& f,
                                                          const char* value);
...
template int iscool::strings::detail::append_to_formatter<int>(formatter& f,
                                                               int value);
template int
iscool::strings::detail::append_to_formatter<unsigned int>(formatter& f,
                                                           unsigned int value);
template int iscool::strings::detail::append_to_formatter<short>(formatter& f,
                                                                 short value);
template int iscool::strings::detail::append_to_formatter<unsigned short>(
    formatter& f, unsigned short value);
template int iscool::strings::detail::append_to_formatter<long>(formatter& f,
                                                                long value);
template int iscool::strings::detail::append_to_formatter<unsigned long>(
    formatter& f, unsigned long value);
template int
iscool::strings::detail::append_to_formatter<long long>(formatter& f,
                                                        long long value);
template int iscool::strings::detail::append_to_formatter<unsigned long long>(
    formatter& f, unsigned long long value);
template int iscool::strings::detail::append_to_formatter<float>(formatter& f,
                                                                 float value);
template int
iscool::strings::detail::append_to_formatter<double>(formatter& f,
                                                     double value);
