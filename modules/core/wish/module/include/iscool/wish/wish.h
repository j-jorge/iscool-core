...
#define DETAIL_WISH_FIELD_TYPE( seq )           \
        BOOST_PP_SEQ_ELEM( 0, seq )

#define DETAIL_WISH_FIELD_NAME( seq )           \
...
#define DETAIL_WISH_CONSTRUCTOR_FIELD( r, data, i, seq )        \
        BOOST_PP_COMMA_IF( i ) DETAIL_WISH_FIELD_TYPE( seq )    \
        DETAIL_WISH_FIELD_NAME( seq )
...
#define DETAIL_WISH_CONSTRUCTOR_INITIALIZATION( r, data, i, seq )       \
        BOOST_PP_COMMA_IF( i ) DETAIL_WISH_MEMBER_NAME( seq )           \
        ( DETAIL_WISH_FIELD_NAME( seq ) )
...
#define DETAIL_WISH_CONSTRUCTOR( name, fields )                         \
        BOOST_PP_IF                                                     \
        ( BOOST_PP_SEQ_SIZE( fields ),                                  \
          DETAIL_WISH_CONSTRUCTOR_IMPL, DETAIL_WISH_EMPTY ) ( name, fields ) 
...
#define DECLARE_SIMPLE_WISH( name )             \
        DECLARE_WISH( name, )
    }
}
