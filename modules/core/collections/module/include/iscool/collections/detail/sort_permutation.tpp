  ...
  namespace collections
  {
    namespace detail
    {
      ...
      struct sort_helper<true>
      {
        ...
        static std::vector<std::size_t> permutation(const Iterator& first,
                                                    const Iterator& last,
...
iscool::collections::sort_permutation(const Iterator& first,
                                      const Iterator& last)
{
    ...
    const Iterator& first, const Iterator& last, const Compare& compare)
{
  return detail::sort_helper<
      std::is_same<typename std::iterator_traits<Iterator>::value_type,
                   bool>::value>::permutation(first, last, compare);
}
