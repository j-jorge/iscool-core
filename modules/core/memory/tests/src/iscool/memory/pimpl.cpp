...
TEST(iscool_memory_pimpl, known_size_auto_allocation)
{
  ...
  EXPECT_GE(static_cast<void*>(&pointer), static_cast<void*>(pointer.get()));
...
TEST(iscool_memory_pimpl, known_size_copy)
{
  ...
  *pointer = 24;
  ...
  EXPECT_GE(static_cast<void*>(&copy), static_cast<void*>(copy.get()));
...
TEST(iscool_memory_pimpl, known_size_move)
{
  ...
  EXPECT_GE(static_cast<void*>(&moved), static_cast<void*>(moved.get()));
...
TEST(iscool_memory_pimpl, unknown_size_constructor_arguments)
{
  ...
  iscool::memory::pimpl<value_type, 0> pointer(873, "yep",
                                               std::vector<int>({ 9, 1 }));
