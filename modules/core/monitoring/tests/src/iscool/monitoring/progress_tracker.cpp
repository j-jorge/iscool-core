...
ic_monitoring_declare_progress_tracker(global_namespace_tracker,
                                       (step_1)(step_2)(step_3));

namespace dummy
{
  ic_monitoring_declare_progress_tracker(in_namespace_tracker,
                                         (step_1)(step_2));
}
...
TEST(iscool_progress_tracker, double_completion_failure)
{
  ...
  EXPECT_DEBUG_CRASH(tracker.done(dummy::in_namespace_tracker::step::step_2));
}
