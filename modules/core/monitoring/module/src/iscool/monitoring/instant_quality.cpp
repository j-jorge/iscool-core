...
*/
#include <iscool/monitoring/instant_quality.hpp>

#include <iscool/signals/implement_signal.hpp>

#include <cassert>

IMPLEMENT_SIGNAL(iscool::monitoring::instant_quality, quality_changed,
                 _quality_changed);
...
void iscool::monitoring::instant_quality::update_quality_level(bool success)
{
  if (_attempts == 0)
    return;
