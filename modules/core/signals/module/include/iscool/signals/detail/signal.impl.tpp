...
iscool::signals::detail::signal<Signature>::connect(std::function<Signature> f)
{
...
void iscool::signals::detail::signal<Signature>::operator()(Arg&&... arg) const
{
  if (_storage_kind == storage_kind::pointer)
    {
...
template <typename Signature>
const typename iscool::signals::detail::signal<
    Signature>::shared_slot_ptr_vector&
