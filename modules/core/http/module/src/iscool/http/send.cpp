...
namespace iscool
{
    namespace http
    {
        namespace detail
        {
            ...
            static iscool::signals::shared_connection_set send_get_request
            ...
            static iscool::signals::shared_connection_set configure_request
            ( request& output, const std::string& url,
...
iscool::signals::shared_connection_set iscool::http::get
( const std::string& url,
  response_handler on_result, response_handler on_error )
{
...
iscool::signals::shared_connection_set iscool::http::post
( const std::string& url, const std::vector<std::string>& headers,
...
( const std::string& url,
  const response_handler& on_result, const response_handler& on_error )
{
