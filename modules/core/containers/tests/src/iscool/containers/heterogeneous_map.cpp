...
TEST( iscool_containers_heterogeneous_map, size_t_float_copy )
{
    ...
    const iscool::containers::heterogeneous_map< std::size_t, float > copy
        ( map );
...
TEST( iscool_containers_heterogeneous_map, string_short_string_char )
{
    iscool::containers::heterogeneous_map
        < std::string, short, std::string, char > map;
    ...
    iscool::optional< std::string > string_value
        ( map.get< std::string >( "string" ) );
...
{
    iscool::containers::heterogeneous_map
        < std::string, short, std::string, char > map_1;
    
    map_1.set( "a", short( 24 ) );
    map_1.set( "b", 'b' );
    
    iscool::containers::heterogeneous_map
        < std::string, short, std::string, char > map_2;
...
TEST( iscool_containers_heterogeneous_map, string_short_string_char_copy )
{
    ...
    const iscool::containers::heterogeneous_map
        < std::string, short, std::string, char > copy( map );
...
TEST( iscool_containers_heterogeneous_map, string_short_string_char_move )
{
    ...
    const iscool::containers::heterogeneous_map
        < std::string, short, std::string, char > moved( std::move( map ) );
