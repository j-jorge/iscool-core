...
namespace iscool
{
    namespace meta
    {
        namespace combien_and_tests
        {
            ...
            {
                typedef
                iscool::meta::combine_and< true, false, true, true, false >
                result_type;
            ...
            {
                typedef
                iscool::meta::combine_and< false, false, true, false, true >
                result_type;
            ...
            {
                typedef
                iscool::meta::combine_and< true, true, true, true, true >
                result_type;
            ...
            {
                typedef
                iscool::meta::combine_and< true, true, true, true, false >
                result_type;
            ...
            {
                typedef
                iscool::meta::combine_and< false, true, true, true, true >
                result_type;
