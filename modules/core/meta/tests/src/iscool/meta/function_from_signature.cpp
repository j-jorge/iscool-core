...
{
    iscool::meta::function_from_signature< void >::type f1( []() -> void {} );
...
TEST( iscool_underlying_type, std_function_void_void )
{
    iscool::meta::function_from_signature< void >
        ::in_functor< std::function >
        ::type f1
        ( []() -> void {} );
    iscool::meta::function_from_signature< void, void >
        ::in_functor< std::function >
        ::type f2
        ( []() -> void {} );
}
...
TEST( iscool_underlying_type, std_function_void_args )
{
    iscool::meta::function_from_signature< void, int >
        ...
        ::type f1
        ( []( int ) -> void {} );
    iscool::meta::function_from_signature< void, int, float >
        ::in_functor< std::function >
        ::type f2
        ( []( int, float ) -> void {} );
}
...
TEST( iscool_underlying_type, std_function_int_void )
{
    iscool::meta::function_from_signature< int >
        ...
        ::type f1
        ( []() -> int { return 0; } );
    iscool::meta::function_from_signature< int, void >
        ::in_functor< std::function >
        ::type f2
        ( []() -> int { return 0; } );
}
...
TEST( iscool_underlying_type, std_function_int_args )
{
    iscool::meta::function_from_signature< int, int >
        ...
        ::type f1
        ( []( int ) -> int { return 0; } );
    iscool::meta::function_from_signature< int, int, float >
        ::in_functor< std::function >
        ::type f2
        ( []( int, float ) -> int { return 0; } );
}
