...
TEST( iscool_resources_catalog, texture )
{
    ...
    const iscool::resources::catalog catalog
        ( textures, particles, sounds, styles );
...
TEST( iscool_resources_catalog, sprite_sheet )
{
    ...
    iscool::test::assert_equal_collections
        ( expected, catalog.get_sprite_sheets() );
...
TEST( iscool_resources_catalog, insert )
{
    ...
    delegates.file_exists =
        []( const std::string& s ) -> bool
        {
            return
                ( s == "a_skeleton.json" )
                || ( s == "a_skeleton.atlas" )
                || ( s == "a_sprite_sheet.plist" )
                || ( s == "b_skeleton.json" )
                || ( s == "b_skeleton.atlas" )
                || ( s == "b_sprite_sheet.plist" );
        };
    ...
    const std::vector< std::string > particles_a
        {
            "a_particles_1",
            "a_particles_2",
            "a_particles_3"
    ...
    const std::vector< std::string > sounds_a
        {
            "a_sounds_1",
            "a_sounds_3"
        };
    
    const std::vector< std::string > styles_a
        {
            "a_styles_3"
        };

    iscool::resources::catalog catalog
        ( textures_a, particles_a, sounds_a, styles_a );
    ...
    const std::vector< std::string > particles_b
        {
            "b_particles_1",
            "b_particles_2",
            "b_particles_3"
    ...
    const std::vector< std::string > sounds_b
        {
            "b_sounds_1",
            "b_sounds_3"
        };
    
    const std::vector< std::string > styles_b
        {
            "b_styles_3"
        };
    ...
    catalog.insert
        ( iscool::resources::catalog
          ( textures_b, particles_b, sounds_b, styles_b ) );
    ...
    const std::vector< std::string > expected_sounds
        {
            "a_sounds_1",
            "a_sounds_3",
            "b_sounds_1",
    ...
    const std::vector< std::string > expected_skeletons
        {
            "a_skeleton",
            "b_skeleton"
        };
    ...
    const std::vector< std::string > expected_sprite_sheets
        {
            "a_sprite_sheet.plist",
            "b_sprite_sheet.plist"
        };
    
    iscool::test::assert_equal_collections
        ( expected_textures, catalog.get_textures() );
    iscool::test::assert_equal_collections
        ( expected_particles, catalog.get_particles() );
    iscool::test::assert_equal_collections
        ( expected_sounds, catalog.get_sounds() );
    iscool::test::assert_equal_collections
        ( expected_styles, catalog.get_styles() );
    iscool::test::assert_equal_collections
        ( expected_skeletons, catalog.get_skeletons() );
    iscool::test::assert_equal_collections
        ( expected_sprite_sheets, catalog.get_sprite_sheets() );
