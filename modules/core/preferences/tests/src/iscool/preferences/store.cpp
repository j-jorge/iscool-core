...
class iscool_preferences_store_test : public ::testing::Test
{
public:
...
protected:
  typedef std::function<void(iscool::preferences::property_map)> save_function;
...
iscool_preferences_store_test::iscool_preferences_store_test()
{
  ...
  _empty_save_function = [](iscool::preferences::property_map) -> void
  {
    ASSERT_TRUE(false);
  };
...
{
  iscool::preferences::store store(std::chrono::milliseconds::zero(),
                                   _initial_values, _empty_save_function);
...
{
  iscool::preferences::store store(std::chrono::milliseconds(10),
                                   _initial_values,
                                   _copy_values_save_function);
...
{
  iscool::preferences::store store(std::chrono::milliseconds(5),
                                   _initial_values,
                                   _copy_values_save_function);
...
TEST_F(iscool_preferences_store_test, get_keys_empty)
{
  ...
  iscool::preferences::store store(std::chrono::milliseconds(5),
                                   initial_values, _copy_values_save_function);
