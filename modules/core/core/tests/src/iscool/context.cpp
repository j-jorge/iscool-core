...
*/
#include "iscool/context.h"

#include "iscool/test/debug_crash.h"

#include <gtest/gtest.h>

struct iscool_root_context_test:
    public testing::Test
{
    ic_declare_context
    ( _context, 
      ic_context_no_parent_properties,
...
TEST_F
( iscool_root_context_test, assert_if_parent_values_not_set_at_construction )
{
    EXPECT_DEBUG_CRASH
